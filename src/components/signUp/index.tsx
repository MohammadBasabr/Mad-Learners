...
import EmployeeSignUp from "./employee";

interface SignUpProps extends React.PropsWithChildren {}

export const SignUp: React.FunctionComponent<SignUpProps> = (): JSX.Element => {
    ...
    return (
      <section className="flex flex-col h-[calc(100vh-96px)] w-full items-center justify-between bg-light-primary dark:bg-dark-primary md:h-[calc(100vh-176px)] md:p-6">
        ...
        <div className="relative flex flex-row justify-between h-full w-full">
          <div
           className={`${
          ...
          >
            ...
            >
              Register as {` ${toggle ? "an employee" : "a student"}`}
            </span>
          </div>                    
