  ...
  return (
    <>
      <div className={open ? `p-2 w-full` : `hidden p-2 w-full`}>
        ...
        >
          <Form className="flex flex-col w-full select-none gap-2">
            <label htmlFor="lessonName">lessonName</label>
            <Field
              id="lessonName"
              name="lessonName"
              className="p-2 outline-none rounded-md bg-dark-secondary"
            />
            ...
            <button
              type="submit"
              className="mt-4 p-2 uppercase font-bold bg-dark-hover text-dark-primary rounded-lg"
            >
              Submit
            </button>
          </Form>
